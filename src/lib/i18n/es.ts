...
export const es: TranslationKeys = {
  ...
  courses: {
    catalog: {
      ...
      noResults: 'No se encontraron cursos con tus filtros.',
    },
    difficulty: {
    ...
    detail: {
      ...
      syllabus: 'Programa',
      reviews: 'Reseñas',
      reviewsPlaceholder: 'Reseñas de la comunidad próximamente. ¡Completa el curso y sé el primero en compartir tu experiencia!',
    },
    progress: {
      complete: 'Completado',
  ...
  lesson: {
    ...
    challenge: {
      ...
      expected: 'Esperado:',
      actual: 'Obtenido:',
      passedCount: '{{passed}}/{{total}} pasaron',
    },
  },
  dashboard: {
    title: 'Panel',
    ...
    noCourses: '¡Sin cursos aún. Empieza a aprender!',
    noActivity: 'Sin actividad reciente.',
    nextLesson: 'Siguiente: {{name}}',
    stats: {
      totalXP: 'XP Total',
      level: 'Nivel',
  ...
  leaderboard: {
    ...
    streak: 'Racha',
    you: 'Tú',
    noRankings: '¡Sin clasificaciones aún. Sé el primero!',
  },
  profile: {
    title: 'Perfil',
    ...
    noCourses: '¡Sin cursos completados aún. Sigue aprendiendo!',
    minted: 'Acuñado',
    mintCNFT: 'Acuñar cNFT',
    ...
    skillFundamentals: 'Fundamentos',
    skillRustAnchor: 'Rust & Anchor',
    skillDefi: 'DeFi',
  ...
  settings: {
    title: 'Configuración',
    verifyWalletMessage: 'SolDojo: verificar propiedad de billetera',
    profile: {
      title: 'Perfil',
  ...
  certificates: {
    ...
    merkleTree: 'Árbol Merkle',
    shareText: 'Gané la credencial "{{name}}" en SolDojo! #Solana #Web3 @SuperteamBR',
  },
  gamification: {
    xp: 'XP',
    level: 'Nivel {{level}}',
  ...
  errors: {
    ...
    notFoundMessage: 'Esta página no existe en ninguna chain.',
    ...
    loadCourses: 'Error al cargar cursos. Inténtalo de nuevo.',
    loadDashboard: 'Error al cargar el panel. Inicia sesión e inténtalo de nuevo.',
    loadLeaderboard: 'Error al cargar la clasificación. Inténtalo de nuevo.',
    loadProfile: 'Error al cargar el perfil. Inicia sesión e inténtalo de nuevo.',
    runCode: 'Ocurrió un error al ejecutar tu código.',
    loadLesson: 'Error al cargar la lección. Inténtalo de nuevo.',
    loadCourse: 'Error al cargar el curso. Inténtalo de nuevo.',
  },
  time: {
    justNow: 'Ahora mismo',
